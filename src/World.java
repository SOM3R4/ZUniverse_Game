...
public class World {
	...
	public World() {
		...
		blocos.add(new Blocks(220+32,100));
		blocos.add(new Blocks(220+64,100));
		blocos.add(new Blocks(316,100));
		blocos.add(new Blocks(316,132));
		blocos.add(new Blocks(316,164));
		blocos.add(new Blocks(316,196));
